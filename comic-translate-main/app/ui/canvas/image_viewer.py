...
class ImageViewer(QtWidgets.QGraphicsView):
    ...
    def load_state(self, state: Dict):
        ...
        for text_block in state.get('text_items_state', []):
            font_family = text_block.get('font_family')
            # On force la police globale sauf si le bloc a une police différente explicitement définie
            if font_family_setting and (not font_family or font_family == '' or font_family == 'None'):
